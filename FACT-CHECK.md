# Bodaiju Residences — Site Fact-Check Log

Last full fact-check: **June 2026**. Method: every rendered claim traced to the
...
|---|---|---|
| Foreign MOT stamp duty **8% flat**, eff. 1 Jan 2026 (from 4%) | TRUE | Budget 2026; KPMG; global law experts |
| Citizen MOT bands 1/2/3/4% | TRUE | Stamp Act; Budget 2026 |
| Johor state consent **3% or RM30k min**, eff. 1 Jul 2025 | TRUE | PTG Johor Circular 1/2025; The Star 18 Jun 2025 |
| RPGT non-citizen 30% (yr 1–5), 10% (yr 6+) | TRUE | LHDN/HASIL |
| JS-SEZ signed **7 Jan 2025** (Gan Kim Yong + Rafizi Ramli) | TRUE | Singapore EDB |
| Medini exempt from RM1m foreign min (new strata, direct from developer) | TRUE | IRDA; EdgeProp |
| Creed Group est. 1996; 928-unit Bodaiju Phnom Penh, completed Jan 2020 | TRUE | creed-group.com; realestate.com.kh |
| MGB RM185.99m contract from CI Medini, LOA 12 Aug 2025; 802 units | TRUE | The Star; NST; Bursa |
| RTS Link ~5-min crossing, operations targeted Jan 2027 | TRUE | Transport Min. Loke, Jan 2026 |
| OPR 2.75% (held since 9 Jul 2025) | TRUE — still 2.75% | Bank Negara; NST May 2026 |

## 🔧 CORRECTED in this pass
- **RTS progress figure** ("~65% / Nov 2025") was stale — replaced; no hard % is
  officially published. Service framing set to "January 2027". (Was not rendered
  on any page, but cleaned in the data file.)
- **Cost FAQ** "roughly 12% on top" understated it — corrected to "13–20%
  transaction costs", noting the RM30k consent floor hits low-priced units harder
  (matches the calculator: RM299k ≈ 19.9%, RM610k ≈ 14.8%).
- **Selling point** "in 5 minutes" softened to match location data (EduCity 2–4 km,
  LEGOLAND ~2 km, "short drive").

## ✅ Calculator arithmetic — independently re-derived, correct
8% foreigner MOT, max(3%, RM30k) consent, 0.5% loan stamp, ~1.5% legal, 70% LTV,
...
writing. LIKELY items stay caveated. Re-check macro facts (stamp duty, OPR, RTS)
before each campaign — they move.
